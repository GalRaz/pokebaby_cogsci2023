...
# reparameterized to check for slope on deviant
...
saveRDS(model_1c, here("cached_data/infants/model_1c.rds"))
...
model_2b_df <- tidy(model_2c) %>%  mutate_if(is.numeric, round, 2)
model_2b_df <- tidy(model_2d) %>%  mutate_if(is.numeric, round, 2)
